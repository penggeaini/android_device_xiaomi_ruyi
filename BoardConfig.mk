...
# 内核命令行（从 /proc/cmdline 精简，保留关键部分）
...
# 分区大小（已从 /proc/partitions 精确计算）
BOARD_BOOTIMAGE_PARTITION_SIZE := 0x06000000      # boot_b: 98304*1024=100663296
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 0x06400000  # recovery_b: 102400*1024=104857600
BOARD_VENDOR_BOOTIMAGE_PARTITION_SIZE := 0x06000000
BOARD_USERDATAIMAGE_PARTITION_SIZE := 0xC80000000 # 约50GB，临时值不影响
